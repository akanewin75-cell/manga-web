                    ...
                    <div class="bg-lunar-base/50 p-4 rounded-2xl border border-lunar-border text-left cursor-pointer group hover:border-lunar-accent/50 transition-soft"
                            ...
                            async toggle() {
                                ...
                                try {
                                    ...
                                    if (window.addNotification) {
                                        window.addNotification(this.nsfw ? '18+ Sector Unlocked' : '18+ Transmission Blocked', 'info');
                                    }
                                } catch (error) {
                                    ...
                                    this.nsfw = !this.nsfw;
                                    if (window.addNotification) {
                                        window.addNotification('System Failure: Could not update restrictions', 'error');
                                    } else {
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-[9px] text-gray-500 font-medium uppercase tracking-tighter" x-text="nsfw ? 'Currently: Sector Unlocked' : 'Currently: Transmission Blocked'"></span>
                            </div>
                            <button type="button" 
                                ...
                                <span aria-hidden="true" 
                                    ...
                                    :class="nsfw ? 'translate-x-6' : 'translate-x-0'"></span>
                            </button>
                        </div>
                    </div>
                </div>
